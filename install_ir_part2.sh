...
# --- 2. Закомментировать dtoverlay=gpio-ir из userconfig.txt ---
echo "[2/7] Disabling conflicting dtoverlay in userconfig.txt..."
...
echo "[5/7] Creating irexec override..."
...
echo "[6/7] Creating irexec.lircrc symlink..."
